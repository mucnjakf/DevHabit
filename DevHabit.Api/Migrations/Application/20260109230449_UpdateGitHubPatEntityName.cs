...
{
    /// <inheritdoc />
    public partial class UpdateGitHubPatEntityName : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_git_hub_pats", x => x.id);
                    table.ForeignKey(
                        name: "fk_git_hub_pats_users_user_id",
                        column: x => x.user_id,
