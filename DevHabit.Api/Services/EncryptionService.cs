...
public sealed class EncryptionService(IOptions<EncryptionOptions> encryptionOptions)
{
    private const int IvSize = 16;

    private readonly byte[] _masterKey = Convert.FromBase64String(encryptionOptions.Value.Key);
    ...
    public string Decrypt(string cipherText)
    {
        ...
        {
            throw new InvalidOperationException("Invalid cipher text format", e);
        }
    }
}
